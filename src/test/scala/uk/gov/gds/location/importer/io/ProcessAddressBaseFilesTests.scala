...
//      addressBaseFileProcessors.processAddressBaseForAddresses(new File("/tmp/shouldnotbehere")) must beFalse
//      addressBaseFileProcessors.processAddressBaseForStreets(new File("/tmp/shouldnotbehere")) must beFalse
//      addressBaseFileProcessors.processCodePointFile(new File("/tmp/shouldnotbehere")) must beFalse
//    }
//  }
  //
