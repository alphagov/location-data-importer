...
class Addresses(tag: Tag) extends Table[(
  String, String, String, String, Timestamp, Option[String], Option[String], Option[String], Option[String], Option[String], Double, Double,
    Option[Int], Option[String], Option[Int], Option[String], Option[Int], Option[String], Option[Int], Option[String], Option[String], Option[String]
  )](tag, "addresses") {
  ...
  def * = (
    uprn, postcode, country, gssCode, createdAt, property, street, locality,
    town, area, lat, long, saoStartNumber, saoStartSuffix, saoEndNumber, saoEndSuffix,
    paoStartNumber, paoStartSuffix, paoEndNumber, paoEndSuffix, paoText, saoText
    )
}
